            ...
            <div class="accordion" id="accordionExps">
                <div class="accordion-group" style="border:0">
                    <div class="accordion-heading">
                        <span class="glyphicon glyphicon-cog"></span> <span id="expTotal"
                                                                            class="badge badge-info"></span> experiments
                        (with <span id="expRunning" class="badge">&nbsp;</span> running and <span id="expUpcoming"
                                                                                                  class="badge"></span>
                        upcoming)
                        <a data-toggle="collapse" data-parent="#accordionExps" href="#collapseExps"
    ...
    <div class="row" id="statsNodes" style="display:none;border-bottom:1px solid #CCCCCC;padding-bottom:10px;">
        <div class="col-md-12">
            ...
            <div class="accordion" id="accordionNodes">
                <div class="accordion-group" style="border:0">
                    <div class="accordion-heading">
                        <span class="glyphicon glyphicon-download-alt"></span> <span id="nodesTotal"
                                                                                     class="badge badge-info"></span>
                        nodes (with <span id="nodesFree" class="badge">&nbsp;</span> free, <span id="nodesBusy"
                                                                                                 class="badge"></span>
                        busy and <span id="nodesUnavailable" class="badge badge-warning"></span> unavailable)
                        <a data-toggle="collapse" data-parent="#accordionNodes" href="#collapseNodes"
                           style="color:#333;text-decoration:none">
                            <button class="btn btn-default"><b class="caret"></b></button>
                        </a>
                    </div>
    ...
    <div class="row" id="statsUsers" style="display:none;padding-bottom:10px;">
        <div class="col-md-12">
            ...
            <div class="accordion" id="accordionUsers">
                <div class="accordion-group" style="border:0">
                    <div class="accordion-heading">
                        <span class="glyphicon glyphicon-user"></span> <span id="usersTotal"
                                                                             class="badge badge-info"></span> users
                        (with <span id="usersAdmin" class="badge"></span> admins and <span id="usersPending"
                                                                                           class="badge badge-warning"></span>
                        pending)
                        <a data-toggle="collapse" data-parent="#accordionUsers" href="#collapseUsers"
                           style="color:#333;text-decoration:none">
                            <button class="btn btn-default"><b class="caret"></b></button>
                        </a>
                    </div>
