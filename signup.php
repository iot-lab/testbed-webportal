        ...
        <div class="col-md-8">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-9">
              ...
              <input id="txt_email" class="form-control" type="email" required="required"  placeholder="&lt;Please fill with an academic or professional address&gt;">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-9">
                <select id="txt_country" class="form-control" required="required"><?php include 'scripts/countries.html'; ?>
                </select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-9">
                <textarea id="txt_motivation" class="form-control" id="textarea" rows="5" required="required"></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-lg-offset-3 col-lg-9">
                <div class="checkbox">
                	<label>
                		<input id="charter" class="form-control" name="charter" type="checkbox" required="required" />I read and I accept <a href="http://www.senslab.info/users/senslab-charter/" target="_blank">Senslab Terms of Service</a>.
                    </label>
                </div>
            </div>
          </div>
