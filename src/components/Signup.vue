  ...
  <div class="row">
    <div class="col-lg-9">
      ...
      <template v-else>
        ...
        <form class="card bg-light card-body mb-5" @submit.prevent="signup">
          <div class="row">
            <div class="col-md">
            ...
            <div class="col-md">                    
              ...
              <div class="form-group">
                ...
                <span class="text-danger">Please fill with an <b>academic</b> or <b>professional</b> email in order to validate your account <b>(no gmail, hotmail, &#x2026;)</b></span>
              </div>
          <div class="row">
            <div class="col-md">
              <div class="form-group">
          ...
          <div class="form-group">
            ...
            <button class="btn btn-lg btn-secondary" type="button" @click="reset">Login</button>
          </div>
