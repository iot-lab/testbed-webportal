	...
	<div class="row" style="margin-top: 50px;">
		...
		<div class="col-md-6 well">
		            ...
		            <form class="form-horizontal" id="modify_ssh_form">
						...
						<button id="btn_modify_ssh_form" class="btn btn-primary" type="submit" style="margin-top: 6px;">Modify SSH keys</button>
		...
		<div class="col-md-5 col-md-offset-1 well">
			...
			<form id="modify_password_form" class="form-horizontal">
				<input id="txt_current_password_modify_password_form" placeholder="Current password" class="form-control" type="password" required="required" style="margin-bottom:5px;"/>
				<input id="txt_new_password_modify_password_form" placeholder="New password" class="form-control" type="password" required="required" style="margin-bottom:5px;"/>
				<input id="txt_cnew_password_modify_password_form" placeholder="Confirm new password" class="form-control" type="password" required="required" style="margin-bottom:5px;"/>
				<button id="btn_modify_password_form" class="btn btn-primary" type="submit" style="margin-bottom:5px;">Modify password</button>
			</form>
		</div>
