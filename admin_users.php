						...
						<div class="tab-content">				
							...
							<form class="well form-horizontal" id="form_add_SA">
				              ...
				              <div class="form-group">
				                ...
				                <div class="col-lg-8">
				                    <input id="txt_structure_SA" type="text" class="form-control" required="required" />
				                </div>
				              </div>
				              ...
				              <div class="form-group">
					            ...
					            <div class="col-lg-8">
									<select id="txt_country_SA" class="form-control" required="required"><?php include '../scripts/countries.html'; ?>
					              	</select>
				                </div>
				              </div>
							...
							<form class="well form-horizontal" id="form_add_MA">
				              ...
				              <div class="form-group">
				                <label class="col-lg-3 control-label" for="txt_howmany_MA">How many accounts:</label>
				                <div class="col-lg-8">
				                    <input id="txt_howmany_MA" type="text" class="form-control" required="required" value="1"/>
				                </div>
				              </div>
				              ...
				              <div class="form-group">
				                ...
				                <div class="col-lg-8">
				                    <input id="txt_structure_MA" type="text" class="form-control" required="required" />
				                </div>
				              </div>
				              ...
				              <div class="form-group">
					            ...
					            <div class="col-lg-8">
									<select id="txt_country_MA" class="form-control" required="required"><?php include '../scripts/countries.html'; ?>
					              	</select>
				                </div>
				              </div>
			       ...
			       <div class="modal-body">
						...
						<form class="well form-horizontal" id="form_modify_user">
				              ...
				              <div class="form-group">
				                ...
				                <div class="col-lg-8">
				                    <input id="txt_login_e" type="text" class="form-control" required="required" disabled="disabled"/>
				                </div>
				              </div>
